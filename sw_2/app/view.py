...
class MainWindowView(QMainWindow):
    ...
    def _setup_ui(self) -> None:
        self.setWindowTitle("OpenCV Task 2")
        ...
        self.left_camera_button = QPushButton("Get image from camera")
        ...
        self.right_camera_button = QPushButton("Get image from camera")
        ...
        transform_buttons_layout.addStretch(1)
